...
The package `ggplot2` implement graphs based on the grammar of graphs ideas. A good reference for ggplot can be found at <http://ggplot2.tidyverse.org/reference/>.

The concept for this plotting framework was laid out by Leland Wilkinson in his 1999 book *Grammar of Graphics*.
...
Essential Grammatical Elements: Data, Aesthetics, and Geometries

- Data


construct plot by adding layers of grammatical elements untop of each other
use aesthetic mappings to define our visualizations
